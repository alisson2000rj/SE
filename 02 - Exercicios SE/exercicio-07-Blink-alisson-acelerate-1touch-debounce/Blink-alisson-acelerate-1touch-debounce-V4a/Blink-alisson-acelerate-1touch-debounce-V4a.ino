 ...
 * heuristica desenvolvida com base no Sketch Debounce existente na IDE 1.8.5 do Arduino e no material encontrado no canal youtube brincando com ideas - Programacao com arduino 
 * aula 13 - delay e millis
 * 
 * versao - 4a  *** numero das versoes seguem o padrao "numeroletra". Ex.: 1a Sendo que a letra varia de a-e;   
 * 30/08/2018 - 12:34pm
 *
...
int spd = 1000; // frequancia com que o led pisca. Inicia piscando a cada 1000ms ou 1s.

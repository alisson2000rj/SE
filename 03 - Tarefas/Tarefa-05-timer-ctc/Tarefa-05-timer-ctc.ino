...
void setup()
{
  DDRB |= 1 << 3; // Ativa o pino 11 (PB5) como OUTPUT para o LED - Legenda: 0 INPUT - 1 OUTPUT
  DDRB |= 1 << 4; // Ativa o pino 12 (PB5) como OUTPUT para o LED - Legenda: 0 INPUT - 1 OUTPUT
